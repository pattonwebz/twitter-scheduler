...
The plugin relies on the WP_Cron system to operate. A cron needs to fire near the time of your scheduled tweets.
...
= 0.1.0 =
* Likely initial production version.
